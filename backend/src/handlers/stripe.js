...
// Pricing configuration - Market-aligned per research document
// Free tier: 1 forum, 2000 members (market expectation, drives adoption and upsells)
const PRICING = {
  starter: {
  ...
  try {
    ...
    return {
      ...
      body: JSON.stringify({
        ...
        maxMembersPerForum: user?.maxMembersPerForum || 2000
      })
    };
